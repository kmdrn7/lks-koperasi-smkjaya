...
Partial Class frmJenisBarang
    ...
    Private Sub InitializeComponent()
        ...
        Me.Label7.Text = "Kode Jenis Barang"
        '
        'Label3
        '
        ...
        Me.Label3.Text = "   Informasi Jenis Barang   "
        '
        'GroupBox1
        '
        ...
        Me.Label6.Size = New System.Drawing.Size(318, 21)
        Me.Label6.TabIndex = 5
        Me.Label6.Text = "Tambah, Ubah dan Hapus data jenis barang"
        '
        'Label1
        '
